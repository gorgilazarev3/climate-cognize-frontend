                ...
                <div className="col-3 bg-light text-start rounded-3 border-light-subtle border shadow-sm">
                    <div className="mb-3">
                        ...
                        {tasks.map((task, index) => {
                            return (
                                <div key={`${task}-${index}`} class="btn-group btn-group-sm ms-3 rounded-3 mb-3 tasks-btn-group" role="group" aria-label="Small button group">
                    ...
                    <div className="mb-3">
                        ...
                        {languages.map((lang, index) => {
                            return (
                                <div key={`${lang}-${index}`} class="btn-group btn-group-sm ms-3 rounded-3 mb-3" role="group" aria-label="Small button group">
                    ...
                    <div className="row row-cols-2 mt-5 justify-content-between">
                        {filteredDatasets(nameFilter).map((dataset, index) => {
                            return (
                                ...
                                <div key={`${dataset}-${index}`} className="col mb-4">
