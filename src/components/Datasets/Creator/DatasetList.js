...
export default function DatasetList(props) {
    ...
    function filteredDatasets(name) {
        return datasets.filter(d => d['name'].toLowerCase().includes(name.toLowerCase()) || d['author'].toLowerCase().includes(name.toLowerCase()));
    }
            ...
            <div className="row">
                ...
                <div className="col-9">
                    <div className="row mb-5">
                        <div className="col">
                            <p>Datasets <span className="text-muted ps-3 small">{filteredDatasets(nameFilter).length}</span></p>
                        </div>
                        <div className="col">
                    ...
                    <div className="row row-cols-2 mt-5 justify-content-between">
                        {filteredDatasets(nameFilter).map((dataset, index) => {
                            return (
                                ...
                                <div className="rounded-3 col bg-light dataset-card p-2" key={dataset['name']}>
                                    <div className="row">
